...
void Stack_Init( Stack *stack ) {
	...
	{
		/*
		 * Nastavení vrcholu zásobníku na hodnotu -1 => značí prázdný zásobník.
		 */
		stack->topIndex = -1;
	}
}
...
int Stack_IsEmpty( const Stack *stack ) {
	/*
	 * Pokud je vrchol zásobníku nastaven na hodnotu -1, je zásobník 
	 * prázdný a je vrácena nenulová hodnota.
	 * V opačném případě podmínka výrazu není splněna a je vrácena 0.
	 */ 
...
int Stack_IsFull( const Stack *stack ) {
	/*
	 * Pokud vrchol zásobníku je nastaven na poslední prvek
	 * je podmínka splněna a vrácena nenulová hodnota, jinak je 
	 * vrácena 0.
	 * Velikost zásobníku (pole array) je STACK_SIZE, ovšem poslední prvek 
	 * zásobníku je na indexu STACK_SIZE - 1 pole array.
	 */
...
void Stack_Top( const Stack *stack, char *dataPtr ) {
	...
	{
		/*
		 * Nastaví hodnotu dataPtr na hodnotu ze zásobníku (pole array)
		 * na pozici vrcholu zásobníku (na indexu topIndex).
		 */ 
...
void Stack_Pop( Stack *stack ) {
	...
	{
		/*
		 * Operace Pop se provede dekrementací ukazatele 
		 * vrcholu zásobníku - topIndex.
		 */
		stack->topIndex--;	
	}	    
}
...
void Stack_Push( Stack *stack, char data ) {
	...
	{
		/*
		 * Nejprve je posunut vrchol zásobníku o jedna a poté
		 * je na tuto pozici vložena daná hodnota.
		 */ 
		stack->topIndex++;
